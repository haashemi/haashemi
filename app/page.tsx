...
const Section = ({ children, className }: React.PropsWithChildren<{ className?: string }>) => (
  <div className={cn("rounded-xl p-5 ring-1 ring-white/10 backdrop-blur-3xl", className)}>{children}</div>
);
          ...
          <div className="grid grid-rows-2 gap-3">
            <Section>
              <p className="pl-2 indent-4">
                {"I'm Ali Hashemi."} A Junior back-end developer with <strong>3+ years</strong> of experience, including
                1+ years of professional experience using Golang. Proficient in developing and maintaining
                high-performance, stable, and reliable web applications. Also interested in front-end development using
