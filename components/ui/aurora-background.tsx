...
export const AuroraBackground = ({
  ...
  return (
    <div
      className={cn(
        'transition-bg fixed h-screen w-screen items-center justify-center overflow-hidden bg-zinc-50 dark:bg-slate-950',
        className,
      )}
      {...props}
    >
      <div
        className={cn(
          `
            ...
            after:absolute after:inset-0 after:animate-aurora after:mix-blend-difference after:content-[""] after:[background-attachment:fixed] 
